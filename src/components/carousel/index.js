...
const items = [
  <div className="imgdiv">
    <div onDragStart={handleDragStart}>
      <img
        className="imglogo"
        src="https://jevelin.shufflehound.com/startup-clean/wp-content/uploads/sites/34/2019/03/kal-visuals-emxAxutgt-A-unsplash.jpg"
        alt=""
      />
      ...
      <h3 className="teacher">Geology teacher</h3>
    </div>
  </div>,
  <div className="imgdiv">
    <div onDragStart={handleDragStart}>
